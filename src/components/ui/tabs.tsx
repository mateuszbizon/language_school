...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-muted text-foreground inline-flex h-9 items-center justify-center rounded-lg p-[3px]",
        className
      )}
      {...props}
    />
